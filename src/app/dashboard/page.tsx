        ...
        <motion.div className="mb-8" variants={itemVariants}>
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge 
              ...
              className={`${
                isProUser 
                  ? "bg-gradient-to-r from-yellow-500 to-orange-500 text-white border-none text-lg px-4 py-2" 
                  : "glass-effect text-lg px-4 py-2"
              }`}
            >
              {isProUser ? (
                <>
              ...
              <Card className={`glass-effect border-none shadow-xl glow-effect hover:shadow-2xl transition-all duration-300 ${stat.bgColor}`}>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className={`w-16 h-16 rounded-xl bg-gradient-to-r ${stat.color} flex items-center justify-center text-white animate-float ml-4`}>
                      {stat.icon}
                    </div>
                  </div>
                </CardContent>
